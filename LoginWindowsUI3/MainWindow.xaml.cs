...
namespace LoginWindowsUI3
{
    ...
    public sealed partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            IntPtr thisWindow = WinRT.Interop.WindowNative.GetWindowHandle(this);               // Intpr
            var thisWindowId=Microsoft.UI.Win32Interop.GetWindowIdFromWindow(thisWindow);       // Get WindowId
